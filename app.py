...
st.title("Dreamy the YouTube AI Assistant")
...
if youtube_url:
    ...
    def hit_relevance_ai(transcript, prompt):
        ...
        with st.spinner(text="Dreamy is thinking..."):
            url = "https://api-d7b62b.stack.tryrelevance.com/latest/studios/4a70d195-c420-4786-9521-b9f77166a67c/trigger_limited"
            headers = {
            ...
            payload = {
                ...
                "project": "05f5a4cd7c20-4b2c-80dc-b24ae6ed2f8d"
            }
